  ...
  },
  {
    ...
    slots: {
      default: (data: any) => {
        ...
        return (
          <>
            <ElButton v-hasPermi="['system.dict.save']" type="primary" link size="small" onClick={() => editAction(row)}>
              编辑
            </ElButton>
            <ElButton v-hasPermi="['system.dict.del']"
              type="danger"
  ...
  <ContentWrap>
    ...
    >
      <template #toolbar>
        <ElRow :gutter="10">
          <ElCol :span="1.5">
            <ElButton type="primary" v-hasPermi="['system.dict.save']" @click="addAction">新增字典类型</ElButton>
          </ElCol>
          <ElCol :span="1.5">
